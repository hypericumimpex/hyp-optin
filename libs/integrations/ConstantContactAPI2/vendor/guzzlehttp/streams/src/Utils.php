<?php
namespace MasterPopups\ConstantContact\GuzzleHttp\Stream;

use MasterPopups\ConstantContact\GuzzleHttp\Stream\Exception\SeekException;
...
class Utils
{
    ...
    /**
     * Alias of MasterPopups\ConstantContact\GuzzleHttp\Stream\Stream::factory.
     *
     * @param mixed $resource Resource to create
     * @param array $options  Associative array of stream options defined in
     *                        {@see \MasterPopups\ConstantContact\GuzzleHttp\Stream\Stream::__construct}
     *
     * @return StreamInterface
     *
     * @see MasterPopups\ConstantContact\GuzzleHttp\Stream\Stream::factory
     * @see MasterPopups\ConstantContact\GuzzleHttp\Stream\Stream::__construct
     */
