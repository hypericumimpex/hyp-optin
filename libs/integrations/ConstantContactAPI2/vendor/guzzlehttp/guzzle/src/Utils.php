...
use MasterPopups\ConstantContact\GuzzleHttp\Ring\Client\CurlHandler;
use MasterPopups\ConstantContact\GuzzleHttp\Ring\Client\CurlMultiHandler;
use MasterPopups\ConstantContact\GuzzleHttp\Ring\Client\StreamHandler;
use MasterPopups\ConstantContact\GuzzleHttp\Ring\Client\Middleware;
...
final class Utils
{
     ...
     *     MasterPopups\ConstantContact\GuzzleHttp\get_path($data, 'foo/baz/bar');
     *
     ...
     * key of a path.
     *
     *     MasterPopups\ConstantContact\GuzzleHttp\get_path($data, 'foo/baz'); // null
     *     MasterPopups\ConstantContact\GuzzleHttp\set_path($data, 'foo/baz/[]', 'a');
     *     MasterPopups\ConstantContact\GuzzleHttp\set_path($data, 'foo/baz/[]', 'b');
     *     MasterPopups\ConstantContact\GuzzleHttp\get_path($data, 'foo/baz');
     *     // Returns ['a', 'b']
     *
