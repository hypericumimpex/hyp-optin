...
use MasterPopups\ConstantContact\GuzzleHttp\Exception\BadResponseException;
use MasterPopups\ConstantContact\GuzzleHttp\Exception\CouldNotRewindStreamException;
use MasterPopups\ConstantContact\GuzzleHttp\Exception\TooManyRedirectsException;
